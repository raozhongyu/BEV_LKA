...
def get_args():
    ...
    parser.add_argument("--lr", type=float, default=2e-4,  # attention
                        help="learning rate")
...
def get_eval_args():
    ...
    parser.add_argument("--data_path", type=str, default="./datasets/kitti/object/training/",
                        help="Path to the root data directory")
    parser.add_argument("--pretrained_path", type=str, default="/home/rao/workspace/cross-view-main/models/argo/dynamic/10_17/weights_75",
